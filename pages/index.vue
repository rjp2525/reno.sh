...
<template>
    <div class="card active card-home">
      ...
      <div class="flex items-center justify-center h-full flex-col">
        <h1 class="m-0 mb-11 text-[54px] md:text-[72px] text-white font-semibold md:tracking-[-0.035em] z-[114]">
          <span class="md:pr-[15px] opacity-60">Reno</span> Philibert
        </h1>
        <div class="m-0 text-[20px] md:leading-[20px] text-white/80 font-extralight z-[114]">
        ...
        <div class="my-4 z-[114] text-md text-white/70 font-extralight">
